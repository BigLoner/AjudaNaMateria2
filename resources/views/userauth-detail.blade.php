    ...
    <header id="header" class="fixed-top d-flex align-items-center header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto " href="{{ route('user.home') }}">Inicio</a></li>
                    <li><a class="nav-link scrollto" href="{{ route('user.regras') }}">Regras</a></li>
                    <li><a href="{{ route('user.blog') }}" class="nav-link scrollto active">Matéria</a></li>
                    @guest
                    @if (Route::has('login'))
                        <li class="nav-item">
                       ...
                       <!-- End comment #4 -->
                        @auth
                            <div class="reply-form">
                                <h4>Comente</h4>
                                <p>A sua identificação será exibida * </p>
                                <form action="{{route('comentarios.store')}}" method="post">
                                    @csrf
                                    <input type="hidden" name='post_id' value="{{$post->id}}">
                                    <div class="row">
                                        <div class="col form-group">
                                            <textarea name="comentario" class="form-control" placeholder="Deixe o seu comentario*"></textarea>
                                        </div>
                                    </div>
